...
[文件结构]
    ...
    └── .claude/
        ...
        ├── rules/                         # 主控下沉的细则（file-structure / workflow-orchestration / dev-workflow-details）
        ├── hooks/                         # 闸门钩子（stop-gate / no-direct-code-guard / tdd-gate / pre-commit-check / three-file-sync-gate / dangerous-pkill-guard / session-rules-banner 等，.sh + .ps1 成对）
        ...
        ├── EVOLUTION.md                   # 进化引擎
        ├── feedback/                      # 经验教训
        ├── scripts/                       # 质量脚本（doctor 自检 / plan-lint / skill-description-lint / fast-mode 开关 / gate-audit）
